...
export default function PaymentModal({ isOpen, setIsOpen, price }) {
  ...
  const launchRazorPay = () => {
      let options = {
          key: "rzp_test_B6duXdwr5mwlY4",
          amount: price*100,
          currency: "INR",
          name: "Book My Show Clone",
          description: "Movie Purchase or Rental",
          image: "https://i.ibb.co/zPBYW3H/imgbin-bookymyshow-office-android-ticket-png.png",
          handler: () => {
              setIsOpen(false);
              alert("Payment Done");
          },
  ...
  return (
    <>
      <Transition appear show={isOpen} as={Fragment}>
        <Dialog
          as="div"
          className="fixed inset-0 z-10 overflow-y-auto z-40"
          onClose={closeModal}
        >
